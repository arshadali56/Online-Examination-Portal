...
<div class="col-md-10">
<a href="mailto:aanasarik@student.iul.ac.in" style="color:#000000">  aanasarik@student.iul.ac.in, hamza@student.iul.ac.in ,tushar@student.iul.ac.in </a><br /><br />
...
<a href="http://www.online-examination.com" target="_blank">About us </a>
</div>
<div class="col-md-3 box">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/Image.jpeg" width=100 height=100 alt="Arshad Ansari" class="img-rounded"><br><br>
     <img src="image/Img2.jpeg" width=100 height=100 alt="MD Hamza" class="img-rounded"><br><br>
     <img src="image/Img3.jpeg" width=100 height=100 alt="Tushar Saxena" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="https://instagram.com/im_arshu16?igshid=ZGUzMzM3NWJiOQ==" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on INSTAGRAM">Arshad Ansari</a>
    <a href="https://instagram.com/hamza07._?igshid=NTc4MTIwNjQ2YQ==" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on INSTAGRAM">md hamza</a>
    <a href="https://instagram.com/tsaxena42?igshid=NTc4MTIwNjQ2YQ==" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on INSTAGRAM">tushar saxena</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 7232990929 8318874566 7457963638     </h4>
		<h4 style="font-family:'typo' ">aanasarik@student.iul.ac.in</h4>
    <h4 style="font-family:'typo' ">hamza@student.iul.ac.in</h4>
    <h4 style="font-family:'typo' ">tsaxena@student.iul.ac.in</h4>
		<h4 style="font-family:'typo' ">Integral University,Lucknow</h4></div></div>
		</p>
      </div>
